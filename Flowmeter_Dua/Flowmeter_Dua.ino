 ...
 * Define Constants
 ****************************************/
#define TOKEN "BBFF-HVdne0u1iK2pip1OaMOuMI5ZAlsuoL" // Your Ubidots TOKEN
#define WIFINAME "iPhone Andy Wahyudi" //Your SSID
#define WIFIPASS "apakabarnya" // Your Wifi Pass
#define MQTTLabelName "Flowmeter3"
...
void loop() {
  ...
  { 
    ...
    Serial.println("L");
    client.add("FLOWMETER3", totalMilliLitres);
